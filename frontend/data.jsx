// Mock data for the ADAS dashboard — driver + fleet
const VEHICLE_MAKES = [
...
// Fleet: synthesize 200 vehicles, slice by tweak
...
window.MY_CAR = MY_CAR;
window.ALERTS_DRIVER = ALERTS_DRIVER;
window.TRIPS = TRIPS;
window.DRIVING_SCORE = DRIVING_SCORE;
window.ALL_VEHICLES = ALL_VEHICLES;
window.FLEET_ALERTS = FLEET_ALERTS;
