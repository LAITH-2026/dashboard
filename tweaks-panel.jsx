    ...
    return (
      <button
        ...
        style={{
          ...
          border: '1px solid rgba(0,0,0,.12)', background: 'rgba(250,249,247,.85)',
          backdropFilter: 'blur(20px) saturate(160%)',
          WebkitBackdropFilter: 'blur(20px) saturate(160%)',
          boxShadow: '0 1px 0 rgba(255,255,255,.5) inset, 0 6px 18px rgba(0,0,0,.15)',
          cursor: 'pointer', color: '#29261b',
